<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite._Login, App_Web_hyw512b1" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div id="login">
    <ul>
      ...
      <a href="../User/Register.aspx" target="_blank">注册</a>｜<a href="../User/GetPassword.aspx" target="_blank">忘记密码</a>
      </li>
    </ul>
</div>
