<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Comment.CommentFor, App_Web_hyw512b1" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head  >
<title>发表评论</title>
<link href="../App_Themes/UserThem/Default.css" type="text/css" rel="stylesheet" />
<script src="../User/UserZone/Cut/style/js/jquery-1.4.js" type="text/javascript"></script>
...
<div id="Comment_List">
    ...
    <asp:Repeater ID="Repeater1" runat="server">
        <ItemTemplate>
            <div  class="div_bot" >
            <div class="nodeDiv"> 
             <%#GetHead(Eval("CommentID"))%>
                <div class="SideBar">
                    评论人：<%# GetUserName(Eval("UserID","{0}")) %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;评论意见：<span class="yijian" ><%# GetPK(Eval("PK","{0}")) %></span> <%#GetLevel(Eval("CommentID"))%></div>
                <div class="ListText">
                    <%# Eval("Contents")%>
                </div>
                <div class="ListTime"><span class="huifu" onclick='showHuiFu(<%#Eval("commentID") %>)' >回复本评论</span>
        ...
        <a name="huifu"></a>
            ...
            <div class="fuMian" >
                ...
                <div class="fuRight" runat="server">
                   ...
                   <div id="rigth2" runat="server">
                   <span class="huifu islogin" onmouseout="this.className='huifu islogin'" onmouseover="this.className='huifu islogin2'"  onclick="Login()" >上传附件，请点此登录</span>
                   </div>
                </div>
            </div>
           <div class="clear"></div>
            <div>
            <asp:PlaceHolder ID="PhValCode" runat="server">验证码：<asp:TextBox ID="TxtValidateCode" MaxLength="6" Width="60" class="l_input" runat="server" onfocus="imgFocus()"></asp:TextBox>&nbsp;<asp:Image ID="VcodeLogin" runat="server" CssClass="imgHead" ImageUrl="~/Common/ValidateCode.aspx" Height="20px" ImageAlign="Middle"  ToolTip="点击刷新验证码"  onclick="this.src='../Common/ValidateCode.aspx?t='+Math.random()" /></asp:PlaceHolder> 
...
<div id="popHead" class="ptitle" ><span class="pspanl">盖楼回复</span><span id="pclose" class="pspanr">关闭</span></div>
 ...
 <div>
    <div>
    评 分：<select id="selScore" name="selScore">
    ...
    <input type="radio" name="ispk" checked="checked" value="1"  />我支持
    <input type="radio" name="ispk"  value="0"  />我反对  
    </div>
    <div class="huileft"> 验证码：<asp:TextBox ID="txthuiVal" MaxLength="6" Width="60" class="l_input" runat="server" onfocus="imghuiFocus()"></asp:TextBox>&nbsp;<asp:Image ID="imghuiVal" runat="server" CssClass="imgHead" ImageUrl="~/Common/ValidateCode.aspx" Height="20px" ImageAlign="Middle"  ToolTip="点击刷新验证码"  onclick="this.src='../Common/ValidateCode.aspx?t='+Math.random()" /></div>
    <div class="huiright"><input type="submit" id="btnhuifu" name="btnhuifu" value=" " onclick="return checkNull()" /></div>
 </div>
</div>
...
<iframe src="login.aspx" frameborder="0" width="200"  ></iframe></div>
</div>
