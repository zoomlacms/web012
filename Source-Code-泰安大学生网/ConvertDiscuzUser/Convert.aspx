<%@ page language="C#" autoeventwireup="true" inherits="ConvertDiscuzUser_Convert, App_Web_go3jwa0f" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <div class="style1" style="text-align: center; height: auto; background-color: #CCCC;
                ...
                <ul>
                    <li id="content" runat="server">
                        <asp:Button ID="Button1" runat="server" Text="开始同步" OnClientClick="clickbutton(this);"
