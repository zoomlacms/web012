...
var jsstaly = "<style>body {font-size:14px;font-family:'Lucida Grande','Lucida Sans Unicode','宋体',arial,verdana,sans-serif;}"
                + "select{border:1px solid #369;font-size:14px;margin:0 5px;}"
                ...
                + "#calendar td {font-size:14px;text-align:center;vertical-align:middle;font-family:'宋体';}"
