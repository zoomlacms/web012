<%@ page language="C#" autoeventwireup="true" inherits="Common_UpLoadFile, App_Web_qjkv2p4n" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div id="divInfo">
    ...
    链接名称：<asp:TextBox ID="LinkName" runat="server" Columns="35" CssClass="btn"></asp:TextBox>
    <br />
	<br />
        ...
        <table cellspacing="0" cellpadding="0" width="100%" border="0" dir="ltr">
		    <tr>
			    ...
			    <td width="100%">
				    ...
				    <input id="Button3" type="button" value="插 入" class="btn" onclick="insertUrl();" />
			    </td>
		    </tr>
	    </table>
    </div>
	...
	<div id="divUpload" style="DISPLAY: none">
	    <table width="100%" cellpadding="4" cellspacing="0" border="0" align="center">                        
            <tr>
                <td colspan="2">
                    文件路径：<asp:TextBox ID="FilePath" runat="server" Columns="35" CssClass="btn" Enabled="false"></asp:TextBox>                        
            ...
            <tr>
                <td colspan="2">
                    ...
                    <asp:Button ID="Button1" runat="server" Text=" 上传 " Height="22px" OnClick="Button1_Click" CssClass="btn" />
