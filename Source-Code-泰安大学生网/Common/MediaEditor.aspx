<%@ page language="C#" autoeventwireup="true" inherits="Common_MediaEditor, App_Web_33xyjpeu" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>上传多媒体文件</title>
        ...
        <tr>
            <td>
                <table width="440" cellpadding="4" cellspacing="0" border="0" align="center">                        
                    <tr>
                        <td colspan="2">
                            多媒体文件路径：<asp:TextBox ID="FilePath" runat="server" Columns="35" Enabled="false"></asp:TextBox>
                            <input id="Button2" type="button" runat="server" value="插 入" class="btn" />
                            </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            宽度：<asp:TextBox ID="TxtWidth" runat="server" Columns="5">600</asp:TextBox>&nbsp;
                            高度：<asp:TextBox ID="TxtHeight" runat="server" Columns="5">500</asp:TextBox>
                            </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            选择文件：<asp:FileUpload ID="FupFile" runat="server" size="35" CssClass="btn" />
                            <asp:Button ID="Button1" runat="server" Text=" 上传 " Height="22px" OnClick="Button1_Click" OnClientClick="return isok()" CssClass="btn" />                              
                        </td>
                    </tr>                                               
                </table>
               </td>
