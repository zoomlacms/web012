<%@ page language="C#" autoeventwireup="true" inherits="Common_FlashEditor, App_Web_33xyjpeu" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
        ...
        <tr>
            <td>
                <table width="440" cellpadding="4" cellspacing="0" border="0" align="center">                        
                    <tr>
                        <td colspan="2">
                            Flash：<asp:TextBox ID="FilePath" runat="server" Columns="35" Enabled="false"></asp:TextBox>
                            <input id="Button2" type="button" runat="server" value="插 入" class="btn" />
                            </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            宽度：<asp:TextBox ID="TxtWidth" runat="server" Columns="5">300</asp:TextBox>&nbsp;
                            高度：<asp:TextBox ID="TxtHeight" runat="server" Columns="5">200</asp:TextBox>
                            </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            上传：<asp:FileUpload ID="FupFile" runat="server" size="35" CssClass="btn" />
