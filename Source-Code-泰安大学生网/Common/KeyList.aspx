<%@ page language="C#" autoeventwireup="true" inherits="Common_KeyList, App_Web_qjkv2p4n" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div>
        <table width="100%" border="0" cellpadding="2" cellspacing="0" class="border">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td align="left">
                    <input type="text" id="UserNameList" size="60" class="l_input" maxlength="200" readonly="readonly"
                        class="inputtext" />
                    <input type="hidden" name="HdnUserName" id="HdnUserName" value="" /></td>
                <td align="center">
                    <input type="button"  name="del1" class="C_input"  style="width:110px;"  onclick="del(1)" value="删除最后" />
        ...
        <table width="100%" border="0" cellpadding="2" cellspacing="0" class="border">
            <tr class="title">
                <td align="left" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                    <b>关键字列表：</b></td>
                <td align="right">
                    <asp:TextBox ID="TxtKeyWord" runat="server" class="l_input"></asp:TextBox>&nbsp;&nbsp;<asp:Button class="C_input"  
            ...
            <tr>
                <td valign="top" colspan="2">
                    ...
                    <asp:Repeater ID="RepUser" runat="server" >
                        ...
                        <ItemTemplate>
                            <td align="center">
                                <a href="#" onclick="<%# "add('" + Eval("listkeyword") + "')"%>">
                                    <%#Eval("listkeyword")%><%#SetItemUser(DataBinder.Eval(Container.DataItem, "listkeyword").ToString())%>                                    </a>
                            </td>
                            <% 
                                i++; %>
                            <% if (i % 8 == 0 && i > 1)
            ...
            <tr class="tdbg">
                <td align="center" colspan="2">
                    <div id="DivAdd" runat="server">
                        <a href="#" onclick="add('<%=m_allUser %>')">增加以上所有关键字</a></div>
                </td>
            </tr>                
        </table>
