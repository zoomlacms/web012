<%@ page language="C#" autoeventwireup="true" inherits="manage_File_Addlinkhttp, App_Web_jgv4phxo" enableEventValidation="false" viewStateEncryptionMode="Never" %>
   ...
   <div class="column">
    ...
    <tr></tr>
      ...
      <tr class="tdbg">
        ...
        <td height="22" align="center"><%#Getwin(Eval("Lwindwows").ToString())%></td>
    ...
    <div>
        <asp:Button ID="Button3" runat="server" CssClass="button"   OnClientClick="return confirm('不可恢复性删除数据,你确定将该数据删除吗？');"
