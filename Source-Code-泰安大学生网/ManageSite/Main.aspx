<%@ page language="C#" autoeventwireup="true" inherits="ManageSite_Main, App_Web_oysymbby" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head>
<title>站群后台初始页</title>
...
<div id="contentBulletin_">
    <table cellspacing="1" cellpadding="2" width="90%" align="center" border="0" id="TABLE1">
        <tbody>
            ...
            <tr class="sysinfo">
                <td align="left">传 真:0791-6161900-8009</td>
                <td align="left">客服电话:0791-&nbsp;6161900&nbsp;&nbsp;</td>
            </tr>
            <tr class="sysinfo">
            ...
            <tr class="sysinfo">
                <td colspan="4" height="20">
                    <div align="center">&copy; 2008-2010 <a href="http://www.zoomla.cn" target="_blank">逐浪软件</a> Inc. All Rights Reserved</div>
                </td>
            </tr>
        </tbody>
    </table>
