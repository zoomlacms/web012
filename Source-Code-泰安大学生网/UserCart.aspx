<%@ page language="C#" autoeventwireup="true" inherits="WebShop_UserCart, App_Web_vs4ncjmc" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head>
<title>加入购物车</title>
...
<div class="s_bright">
	<div class="rg_inout">
        ...
        <asp:Repeater ID="cartinfo" runat="server" OnItemDataBound="cartinfo_ItemDataBound">
            <ItemTemplate>
                  <div <%#(Eval("Bindpro","{0}")=="")?"":"style=background-color:#E6E6E6"%> style=" margin-top:5px; width:100%;height:48px">
			            ...
			            <li style="width:10%;text-align:center;"><input onkeydown="if(event.keyCode==13){ keydo('<%#Eval("id") %>');return false;}" id='num<%#Eval("id") %>' value='<%#DataBinder.Eval(Container, "DataItem.pronum", "{0}")%>' style="width:30px" height='20px' onblur="keydo('<%#Eval("id") %>')"/></li>
			            <li style="width:10%;text-align:center;"><%#getjiage(Eval("proclass", "{0}"), "1", DataBinder.Eval(Container, "DataItem.proid", "{0}"), DataBinder.Eval(Container, "DataItem.pronum", "{0}"))%></li>
			            <li style="width:10%;text-align:center;"><span id='currentpri<%#Eval("id") %>'><%#getjiage(Eval("proclass", "{0}"), "2", DataBinder.Eval(Container, "DataItem.proid", "{0}"), DataBinder.Eval(Container, "DataItem.pronum", "{0}"))%></span></li>
			            <li style="width:5%;text-align:center;"><%#getproscheme(Eval("ID","{0}"))%></li>
			            <li style="width:10%;text-align:center;"><span id='price<%#Eval("id") %>'><%#getprojia(Eval("ID", "{0}"), DataBinder.Eval(Container, "DataItem.pronum", "{0}"))%></span></li>                  
                ...
                <ItemTemplate>
                 <div style="background-color:#F6F6F6">
			            ...
			            <li style="width:10.5%;text-align:center;"><%#getjiage(Eval("proclass", "{0}"), "1", DataBinder.Eval(Container, "DataItem.id", "{0}"), DataBinder.Eval(Container, "DataItem.pronum", "{0}"))%></li>
			            <li style="width:10.5%;text-align:center;"><%#getjiage(Eval("proclass", "{0}"), "2", DataBinder.Eval(Container, "DataItem.id", "{0}"), DataBinder.Eval(Container, "DataItem.pronum", "{0}"))%></li>
			            <li style="width:10.5%;text-align:center;"><%#getprojia(Eval("ID", "{0}"), DataBinder.Eval(Container, "DataItem.pronum", "{0}"))%></li>                  
        ...
        <div style="clear:both;margin-top:3px;margin-left:12px; color:#ccc;"><asp:Label ID="yhq" runat="server" Text="优惠券:" ForeColor=Red  Font-Size=12px></asp:Label>&nbsp&nbsp 
