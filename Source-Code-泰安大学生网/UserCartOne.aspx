<%@ page language="C#" autoeventwireup="true" inherits="WebShop_UserCartOne, App_Web_vs4ncjmc" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head>
<title>加入购物车</title>
    ...
    <div class="s_body">
      ...
      <div style="margin-left:170px; margin-bottom:5px;">
               ...
               <div style=" height:346px; clear:both;">
                    <ul>
                        <li style="width: 100%; background-color: GrayText; color: White; font-weight: bold">其他信息</li>
                    </ul>
                    <ul style="background-color: #F6F6F6; width: 100%">
                        <li style="width: 100%; padding-left:30px; ">
                            ...
                            发票类型：<asp:DropDownList ID="InvType" runat="server"> </asp:DropDownList><br />
