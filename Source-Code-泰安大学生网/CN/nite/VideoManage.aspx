<%@ page language="C#" autoeventwireup="true" inherits="CN_nite_CompanyVideo, App_Web_pmudeehh" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>视频列表</title>
  ...
  <div class="us_topinfo">
    <div class="us_pynews">
      <span class="us_showinfo1">您好
        ...
        </a></span><span> &gt;&gt; </span><span><a title="会员中心" href="/User/Default.aspx" target="_blank">会员中心</a></span><span> &gt;&gt; </span><span>视频管理</span>&nbsp;&nbsp;&nbsp;【<a href="Content/AddVideo.aspx" ><font color="red">上传视频</font></a>】</span> 
    </div>
