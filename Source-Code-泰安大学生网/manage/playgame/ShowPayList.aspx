<%@ page language="C#" autoeventwireup="true" inherits="manage_playgame_ShowPayList, App_Web_iv1miygb" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<script>
function selectnum() {
    parent.document.getElementById("main_right").height = document.body.offsetHeight + 200;
}
</script>
</head>
<body>
