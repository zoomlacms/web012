<%@ page language="C#" autoeventwireup="true" inherits="manage_Pub_Bidmanage, App_Web_wxdzv4no" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function open_title2(userid) {
            ...
            diag.Height = 600;
            diag.Title = "用户资料";
            diag.URL = "../user/Usreinfo.aspx?id=" + userid;
            diag.show();
        }
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span><a href="Settlement.aspx">竞标结算</a></span>
    </div>
    <div class="clearbox">
    </div>
    <br />
