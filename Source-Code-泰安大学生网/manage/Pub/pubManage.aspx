<%@ page language="C#" autoeventwireup="true" inherits="manage_Pub_pubManage, App_Web_wxdzv4no" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span>后台管理</span> &gt;&gt; <span>内容管理</span> &gt;&gt; <a href="pubmanage.aspx">互动模块管理</a>　<a href="pubinfo.aspx"><font color=red>[添加互动模块]</font></a></div>
    <div class="clearbox">
    </div>
