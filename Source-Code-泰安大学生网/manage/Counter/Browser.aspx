<%@ page language="C#" autoeventwireup="true" inherits="manage_Counter_Browser, App_Web_3kvvh0tm" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body onload="OnWindowsLoad()" onresize="OnWindowsReSize()">
    ...
    <div id="divMain" style="height: 100%;">
        ...
        <table class="table" style="border-collapse: collapse; height: 94%; width: 99%;"
            bordercolor="#6595d6" cellspacing="0" cellpadding="2" width="97%" align="center"
