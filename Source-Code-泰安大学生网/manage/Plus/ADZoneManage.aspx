<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Plus.ADZoneManage, App_Web_2rcmpi2o" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body onload="pload()">
 ...
 <div class="r_navigation">
        <span>后台管理</span> &gt;&gt; <span>扩展功能</span> &gt;&gt; <span><a href="ADZoneManage.aspx">广告管理</a></span> &gt;&gt; 版位管理&nbsp;<span style="color:Red">[<a href="ADZone.aspx" style="color: Red" target="_blank">添加版位</a>]</span>&nbsp;
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr align="center">
                <td id="Div" class="titlemouseover">
                    <a href="ADZoneManage.aspx">所有版位 </a>
                </td>
                <td id="Div0" class="tabtitle">
                    <a href="ADZoneManage.aspx?type=0">矩形横幅</a>
                </td>
                <td id="Div1" class="tabtitle">
                    <a href="ADZoneManage.aspx?type=1">弹出窗口</a>
                </td>
                <td id="Div2" class="tabtitle">
                    <a href="ADZoneManage.aspx?type=2">随屏移动</a>
                </td>
                <td id="Div3" class="tabtitle">
                    <a href=" ADZoneManage.aspx?type=3">固定位置</a>
                </td>
                <td id="Div4" class="tabtitle">
                    <a href=" ADZoneManage.aspx?type=4">漂浮移动</a>
                </td>
                <td id="Div5" class="tabtitle">
                    <a href=" ADZoneManage.aspx?type=5">文字代码</a>
                </td>
                <td id="Div6" class="tabtitle">
                    <a href=" ADZoneManage.aspx?type=6">对联广告</a>
                </td>
                <td>
                    &nbsp;
                </td>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="ZoneID"
        Width="100%" AllowPaging="True" PageSize="10" OnRowCommand="Lnk_Click" CssClass="border"
            ...
            <asp:TemplateField HeaderText="操作">
                ...
                <ItemTemplate>
                    ...
                    <asp:LinkButton ID="LinkButton4" runat="server" CommandName="Del" OnClientClick="return confirm('确定要删除此版位吗？');"
                        CommandArgument='<%# Eval("ZoneID") %>'>删除</asp:LinkButton>
                    |
                    <asp:LinkButton ID="LinkButton5" runat="server" CommandName="Clear" OnClientClick="return confirm('确定要清空此版位吗？');"
                        CommandArgument='<%# Eval("ZoneID") %>'>清空</asp:LinkButton>
                    |
    ...
    <asp:CheckBox ID="CheckSelectAll" runat="server" AutoPostBack="True" OnCheckedChanged="CheckSelectAll_CheckedChanged"
        Text="全选" />
    <asp:Button ID="BtnDelete" runat="server" Text="批量删除选定版位" Width="134px" OnClientClick="if(!IsSelectedId()){alert('请选择版位');return false;}else{return confirm('你确定要删除选中的版位吗？')}"
        OnClick="BtnDelete_Click" class="C_input" />
    <asp:Button ID="BtnActive" runat="server" Text="激活版位" OnClientClick="if(!IsSelectedId()){alert('请选择版位');return false;}else{return confirm('你确定要激活选中的版位吗？')}"
        OnClick="BtnActive_Click" class="C_input" />
    <asp:Button ID="BtnPause" runat="server" Text="暂停版位" OnClientClick="if(!IsSelectedId()){alert('请选择版位');return false;}else{return confirm('你确定要暂停选中版位吗？')}"
        OnClick="BtnPause_Click" class="C_input" />
