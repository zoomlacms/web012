<%@ page language="C#" autoeventwireup="true" inherits="manage_Plus_ADGuide, App_Web_2rcmpi2o" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>广告管理</title>
        ...
        <li id="Guide_main">
            <div id="Guide_box">   
                ...
                <ul>                        
                    ...
                    <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="javascript:gotourl('Flex/MyMaterial.aspx');">素材中心</a></li>
                    <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="javascript:gotourl('Flex/MyWork.aspx');">我的作品</a></li>
                    </ul>
                </div>
