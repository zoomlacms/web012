<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Common.DocUpload, App_Web_wp11xj3e" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <table style="height: 100%; border: 0; width: 100%">
        <tr class="tdbg">
            <td valign="top" class="style1">
                完美Word转换:<asp:FileUpload ID="FupFile" runat="server" /><asp:Button ID="BtnUpload" runat="server"
