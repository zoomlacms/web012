<%@ page language="C#" autoeventwireup="true" inherits="manage_User_UserCart, App_Web_mcs1zuhc" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>用户信誉值管理</title>
...
<div class="r_navigation">
	...
	<span>后台管理</span> &gt;&gt; <span>用户管理</span> &gt;&gt; <span>会员管理</span> &gt;&gt; <span><a href='UserManage.aspx'>会员列表</a></span> &gt;&gt; <span>会员信誉值操作</span>
</div>
...
<table width="100%" border="0" cellpadding="5" cellspacing="1" class="border"> 
    ...
    <tr class="tdbg">
        ...
        <td class="bqright"><asp:Label ID="lblUserName" runat="server" Text=""></asp:Label>
          <asp:LinkButton ID="lbUserName" runat="server" PostBackUrl='~/manage/User/Usreinfo.aspx?id=<%=Request.QueryString("UserID") %>'></asp:LinkButton></td></td>
     </tr>
     <tr class="tdbg">
