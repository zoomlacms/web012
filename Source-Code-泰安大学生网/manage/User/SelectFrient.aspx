<%@ page language="C#" autoeventwireup="true" inherits="manage_User_SelectFrient, App_Web_wsjme5du" enableeventvalidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
    <title>查找好友</title>
...
<body>
  <form id="form1" runat="server">
    <div id="TopDiv" runat="server">    
	    <table style="width: 299px;" class="border" align="center">
