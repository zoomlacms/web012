<%@ page language="C#" autoeventwireup="true" inherits="manage_User_SystemUserModel, App_Web_wsjme5du" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span>后台管理</span> &gt;&gt; <span>用户管理</span> &gt;&gt; <span>会员模型</span> &gt;&gt; <span>注册信息</span>&nbsp;&nbsp;【<a href="AddUserModel.aspx" style="color: Red">添加字段</a>】
    </div>
    <div class="clearbox">
    </div>
