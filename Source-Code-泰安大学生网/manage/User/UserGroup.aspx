<%@ page language="C#" autoeventwireup="true" inherits="manage_User_RoomManage, App_Web_wsjme5du" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
    <title>用户组管理</title>
...
<body>
    ...
    <div class="r_navigation">        
        <span>后台管理</span> &gt;&gt;<span>企业办公</span> &gt;&gt;<span>网页聊天系统</span>&gt;&gt;<a href="UserGroup.aspx">添加用户组</a></div>
    <div class="clearbox">
    </div>
    <div>
