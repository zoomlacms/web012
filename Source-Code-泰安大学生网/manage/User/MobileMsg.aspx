<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.Manage.User.MobileMsg, App_Web_mcs1zuhc" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>发送手机短信</title>    
    ...
    <div>
        ...
        <table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td align="right" style="height: 28px; width: 25%;">
                    短信余额：
                </td>
                <td align="left">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <table id="TblAddMessage" width="100%" visible="true" runat="server">
                        <tr>
                            <td>
                                <asp:TextBox ID="TxtInceptUser" runat="server" Width="326px" class="l_input"></asp:TextBox>
                            </td>
                            <td>
                                &nbsp;<span style="color: #0000ff">&lt;=【</span><a href="#" onclick="SelectUser();">
                                    <span style="text-decoration: underline; color: Green;">会员手机列表</span></a><span style="color: #0000ff">】</span>
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox ID="EditorContent" runat="server" Rows="10" TextMode="MultiLine" Width="99%"
