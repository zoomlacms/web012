<%@ page language="C#" autoeventwireup="true" inherits="manage_Boss_Bosstree, App_Web_edtodn0v" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<form id="formGuide" runat="server">
    ...
    <ul>
        ...
        <a href="Bosstree.aspx">显示所有</a>&nbsp;&nbsp;招商名：<asp:TextBox ID="TextBox1" runat="server" class="l_input"></asp:TextBox>
            <asp:Button
            ID="Button1" class="C_input" runat="server" Text="查找" onclick="Button1_Click" />
        </div>
