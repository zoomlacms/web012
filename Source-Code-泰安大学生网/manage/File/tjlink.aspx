<%@ page language="C#" autoeventwireup="true" inherits="manage_File_tjlink, App_Web_43q2gjo3" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
		...
		<span>后台管理</span>&gt;&gt;<span>扩展功能</span> &gt;&gt;<span><a href="tjlink.aspx"></a></span>站内链接<span> &gt;&gt;</span>添加站内链接</div> 
    ...
    <table style="width: 100%; margin: 0 auto;" cellpadding="2" cellspacing="1" class="border">
        ...
        <tr class="tdbg">
            <td class="tdbgleft" align="right" style="width: 105px" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
         ...
         <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td class="style1" align="left">
                <asp:TextBox ID="TxtKeywordText" class="l_input" runat="server" Width="175px" 
       ...
       <tr class="tdbg">
        ...
        <tr class="tdbgbottom">
            <td colspan="2">
             <asp:Button ID="EBtnSubmit" class="C_input" Text="添加"  runat="server" 
