<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.AddOn.Dictionary, App_Web_kcxwa3ur" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="r_navigation">
	...
	<span>后台管理</span>&gt;&gt;<span>其他管理</span> &gt;&gt;数据字典分类:<span style="color:Red"><asp:Label ID="lblCateName" runat="server" Text=""></asp:Label></span>&gt;&gt;<span>数据字典项目列表</span>
</div>
