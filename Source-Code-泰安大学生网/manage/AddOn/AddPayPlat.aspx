<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.AddOn.AddPayPlat, App_Web_kcxwa3ur" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <ContentTemplate>
            <table width="100%" border="0" cellpadding="2" cellspacing="1" class="border" style="margin: 0 auto;">
                ...
                <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                    ...
                    <td>
                        <asp:DropDownList ID="DDLPayPlat" runat="server" Width="130px" AutoPostBack="True" OnSelectedIndexChanged="DDLPayPlat_SelectedIndexChanged">
                        </asp:DropDownList>
