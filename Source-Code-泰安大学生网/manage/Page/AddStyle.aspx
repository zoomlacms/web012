<%@ page language="C#" autoeventwireup="true" inherits="manage_Page_AddStyle, App_Web_gqatopqy" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="r_navigation">
	...
	<span>后台管理</span> &gt;&gt; <span></span> 企业黄页 &gt;&gt; <span><a href="PageStyle.aspx">黄页风格管理</a> &gt;&gt; <span>
  ...
  <tbody id="Tbody1">
    ...
    <tr class="tdbg">
        <td colspan="2" align="center" class="title">
            <span>
                <asp:Literal ID="txtTitle" runat="server"></asp:Literal></span></td>
    </tr>
          ...
          <asp:TextBox ID="Stylename" class="l_input" runat="server" Width="259px"></asp:TextBox>
           <font color=red>*
              <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="Stylename"
                  ErrorMessage="风格名称不能为空!"></asp:RequiredFieldValidator></font></td>
    </tr>
    <tr class="tdbg" id="Tr2" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'" >
      ...
      <td align="left">
          ...
          &nbsp;<a href="javascript:void(0);" onclick="WinOpenDialog('../Template/TemplateListForld.aspx?OpenerText='+escape('StyleUrl')+'&FilesDir=',650,480)">浏览</a>&nbsp;<font color=red>*
              <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="StyleUrl"
                  ErrorMessage="风格路径不能为空!"></asp:RequiredFieldValidator></font>
          </td>
    </tr>
     ...
     <tr class="tdbg" id="Tr4" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'" >
      ...
      <td align="left">
          ...
          &nbsp;<a href="javascript:void(0);" onclick="WinOpenDialog('../Template/TemplateList.aspx?OpenerText='+escape('DefaultTemplate')+'&FilesDir=',650,480)">浏览</a>&nbsp;<font color=red>*
              <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="StyleUrl"
                  ErrorMessage="风格路径不能为空!"></asp:RequiredFieldValidator></font>
          </td>
    </tr>
    ...
    <tr class="tdbg" id="Tr5" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'" >
      ...
      <td align="left">
          ...
          &nbsp;<a href="javascript:void(0);" onclick="WinOpenDialog('../Template/TemplateList.aspx?OpenerText='+escape('NodeTemplate')+'&FilesDir=',650,480)">浏览</a>&nbsp;<font color=red>*
              <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="StyleUrl"
                  ErrorMessage="风格路径不能为空!"></asp:RequiredFieldValidator></font>
          </td>
    </tr>
    ...
    <tr class="tdbg" id="Tr1" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'" >
      ...
      <td align="left">
          ...
          <asp:CheckBox ID="IsDefault" runat="server" Text="默认" />
          ...
          <asp:TextBox ID="ShowImg" class="l_input" runat="server" Width="259px"></asp:TextBox>
           <font color=red>*
              <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="ShowImg"
                  ...
                  <iframe
                                id="bigimgs" style="top: 2px" src="../shop/fileupload.aspx?menu=ShowImg" width="100%"
