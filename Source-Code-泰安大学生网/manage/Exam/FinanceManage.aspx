<%@ page language="C#" autoeventwireup="true" inherits="manage_Question_FinanceManage, App_Web_egi1zcol" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span>后台管理</span> &gt;&gt; <span>教育模块</span> &gt;&gt;<a href="QuestionManage.aspx">在线考试系统</a> &gt;&gt; <a href="OrderList.aspx">订单管理</a>
        &gt;&gt; <span><a href="OrderList.aspx">订单列表</a></span>
    </div>
    <div class="clearbox">
    </div>
            ...
            <asp:Repeater ID="Orderlisttable" runat="server" >
                <ItemTemplate>
                    <tr class="tdbg" id="<%#Eval("id") %>" onmouseover="this.className='tdbgmouseover'"
                        ...
                        <td height="24" align="center">
                        <a onclick="opentitle('../User/Usreinfo.aspx?id=<%#Eval("userId") %>','查看会员')"
