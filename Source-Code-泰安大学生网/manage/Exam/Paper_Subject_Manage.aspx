<%@ page language="C#" autoeventwireup="true" inherits="manage_Question_Paper_Subject_Manage, App_Web_egi1zcol" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>试卷试题管理</title>
     ...
     <asp:Repeater ID="Repeater1" runat="server">
        <ItemTemplate>
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td height="22" align="center">
                 <asp:TextBox ID="txtOrder" runat="server" Text='<%#Eval("OrderBy")%>' class="l_input" Width="50px"> </asp:TextBox>
                </td>
                <td height="22" align="center">
