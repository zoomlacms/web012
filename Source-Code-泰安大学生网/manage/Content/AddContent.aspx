<%@ page language="C#" autoeventwireup="true" validaterequest="false" inherits="ZoomLa.WebSite.Manage.Content.AddContent, App_Web_x0s3sxna" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <tr class="tdbgbottom">
            <td colspan="2" class="style1">
               ...
               <input type="button" class="C_input" id="Editdown" name="Editdown" value="编辑下一项" onclick="ShowTable()" />--%>
                <asp:Button ID="EBtnSubmit" class="C_input" Text="添加项目" OnClick="EBtnSubmit_Click"
                    runat="server" />
                &nbsp;<asp:Button ID="Button6" class="C_input" runat="server" OnClick="Button6_Click"
                    Text="存为草稿" />
