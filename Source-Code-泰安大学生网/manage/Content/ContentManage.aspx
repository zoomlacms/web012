<%@ page language="C#" debug="true" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.ContentManage, App_Web_wdyr0bpz" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
   ...
   <%-- <table cellpadding="2" cellspacing="1" class="border" style="background-color: white;"
        ...
        <tr class="tdbg">
            <td>
                翻新：设置日期：
                <asp:TextBox ID="txtdate" onclick="calendar('txtdate')" runat="server" Width="123px"
                    class="l_input" Height="18px"></asp:TextBox>
                <asp:Image ID="Image2" runat="server" ImageUrl="/App_Themes/AdminDefaultTheme/images/Calendar.gif"
                    ToolTip="鼠标点击左边输入框出现时间选择框" />
                <asp:Button ID="Button12" runat="server" class="C_input" Text="翻新" OnClientClick="if(!IsSelectedId()){alert('请选择要翻新的项目');return false;}"
            ...
            <tr align="center">
               ...
               <td id="TabTitle5" class="tabtitle" onclick="ShowTabs(5)">
                ...
                <td align="right" style="font-size: 12px">
                    本节点工作流：<asp:Label runat="server" ID="lab1" Text=""></asp:Label>
