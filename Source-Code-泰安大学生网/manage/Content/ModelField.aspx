<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.ModelField, App_Web_x0s3sxna" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<span>后台管理</span>&gt;&gt;<span>系统设置</span> &gt;&gt;<a href="ModelManage.aspx">内容模型管理</a>&gt;&gt;<span>模型字段列表</span>&nbsp;<a style="color:Red;" href="AddModelField.aspx?ModelID=<%=Request.QueryString["ModelID"] %>">[添加字段]</a> &nbsp;&nbsp;&nbsp;当前模型:
