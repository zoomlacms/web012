<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.ShowContent, App_Web_x0s3sxna" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
    ...
    <script language="JavaScript" type="text/JavaScript">
        ...
        function ShowTabs(ID) {
            if (ID != tID) {
                ...
                tID = ID;
                if (parent.document.getElementById("main_right")) {
