<%@ page language="C#" autoeventwireup="true" validaterequest="false" inherits="ZoomLa.WebSite.Manage.Template.TemplateEdit, App_Web_ruzueav4" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span>后台管理</span>&gt;&gt;<span> 系统设置 </span>&gt;&gt; <a style="cursor:pointer" onclick="javascript:if(confirm('返回将放弃当前修改，是否继续？')) window.location.href='TemplateManage.aspx';">
            模板管理</a>&gt;&gt;<span> 模板编辑</span>
    </div>
    <div class="clearbox">
    </div>
    <div>
