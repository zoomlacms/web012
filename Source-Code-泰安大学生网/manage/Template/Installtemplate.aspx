<%@ page language="C#" autoeventwireup="true" inherits="manage_Template_Installtemplate, App_Web_ruzueav4" enableEventValidation="false" viewStateEncryptionMode="Never" %>

<!DOCTYPE HTML>
<html>
<head id="Head1" runat="server">
    <title>安装方案</title>
    <link href="/App_Themes/AdminDefaultgetoverTheme/Guide.css" type="text/css"
        rel="stylesheet" />
...
<body>
    ...
    <div class="r_navigation">
        <span>后台管理</span>&gt;&gt;<span>系统设置</span> &gt;&gt;<span><a href="TemplateSet.aspx">方案管理</a></span>
        &gt;&gt;<span> 安装方案</span>
    </div>
    <div class="clearbox">
    </div>
        ...
        <tr>
            <td>
                <asp:Panel ID="Panel1" runat="server">
                    接下来将安装方案《<asp:Literal ID="tempname" runat="server"></asp:Literal>》，安装后会将您的节点、模型及模型字段<font
                        color="red">清除</font>，并置入方案默认数据！安装前请确认您已<font color="green">备份</font>好数据，以防丢失数据。
                    <br />
                    <div id="gallery">
