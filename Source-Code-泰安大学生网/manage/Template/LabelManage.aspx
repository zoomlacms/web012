<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Template.LabelManage, App_Web_vtqndqda" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span>后台管理</span>&gt;&gt;<span>系统设置</span> &gt;&gt;<span><a href="LabelManage.aspx">标签管理</a></span>&gt;&gt;<span><a href="LabelExport.aspx">[从旧版标签升级]</a></span>
    </div>
    <div class="clearbox">
    </div>
