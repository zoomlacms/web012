<%@ page language="C#" autoeventwireup="true" validaterequest="false" inherits="ZoomLa.WebSite.Manage.Template.LabelHtml, App_Web_ruzueav4" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <table style="width: 100%;" cellpadding="2" cellspacing="1" class="border">
                <tr>
                    <td class="spacingtitle" colspan="2" align="center">
                        <span id="LblTitle" style="font-weight: bold;">静态标签设置</span>
                    </td>
                </tr>
                <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                    ...
                    <td class="tdbg" align="left">
                        <asp:TextBox ID="TxtLabelName" class="l_input" runat="server" Width="316px" />
                ...
                <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                    ...
                    <td class="tdbg" align="left">
                        <asp:TextBox ID="TxtLabelIntro" class="l_input" runat="server" TextMode="MultiLine"
                            Columns="50" Rows="3" Height="60px" Width="317px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="tdbgleft" style="text-align: center;">
                        判断模式：
                    </td>
                    <td class="tdbg">
                ...
                <tr id="isbool" runat="server" visible="false">
                    <td class="tdbgleft" style="text-align: center; height: 24px">
                        模式设置：
                    </td>
                    <td class="tdbg">
                ...
                <tr>
                    <td class="spacingtitle" style="text-align: left;" colspan="2">
                        标签内容:<asp:Label ID="Label8" runat="server" Text="(<font color=red>满足</font>判断)" Visible="false"></asp:Label>
                    </td>
                </tr>
                <tr>
