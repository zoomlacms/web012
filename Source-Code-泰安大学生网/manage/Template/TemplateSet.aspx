<%@ page language="C#" autoeventwireup="true" inherits="manage_Template_TemplateSet, App_Web_ruzueav4" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<html>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <a href="AddtemplateSet.aspx">[发布方案]</a>  <a href="TemplateSetOfficial.aspx">[官方方案下载]</a></div>
    <div class="clearbox">
    </div>
    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="border" align="center">
       ...
       <%-- <tr class="gridtitle" align="center" style="height: 25px;">
        ...
        <tr>
            <td style="display: none;" id="servertb" name="servertb">
                <table width="100%" border="0" cellpadding="0" cellspacing="1">
    ...
    <%--
        <table width="100%" border="0" cellpadding="0" cellspacing="1" class="border" align="center">
            <tr class="tdbg" align="left" style="height: 25px;">
                <td width="100%">
                    <asp:CheckBox ID="todelete" runat="server" Text="删除" />
                    <asp:Button ID="Button1" runat="server" CssClass="C_input" Text="提交" />
                </td>
            </tr>
        </table>--%>
    <div class="clearbox">
