<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Template.CssManage, App_Web_vtqndqda" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<link rel="stylesheet" href="/JS/videobox_1.1/css/videobox.css" type="text/css" media="screen" />
<style type="text/css">
    .style1
    {
        width: 20%;
...
<body>
    ...
    <div class="r_navigation">
        <span>后台管理</span>&gt;&gt;<span>系统设置</span> &gt;&gt;<span><a href="CssManage.aspx">风格管理</a></span>
    </div>
    <div class="clearbox">
    </div>
    <table width="100%">
