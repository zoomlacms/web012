<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_AddDeliverType, App_Web_jrgr22id" enableEventValidation="false" viewStateEncryptionMode="Never" %>
   ...
   <tr class="tdbg"  onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'" >
      ...
      <td height="24" >
              <asp:RadioButtonList ID="IsOpen" runat="server" RepeatDirection="Horizontal" 
                  AutoPostBack="True" onselectedindexchanged="IsOpen_SelectedIndexChanged">
