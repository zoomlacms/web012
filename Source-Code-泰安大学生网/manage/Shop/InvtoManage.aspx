<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_InvtoManage, App_Web_jrgr22id" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>发票类型</title>
...
<div class="r_navigation">
    ...
    &gt;&gt; <span><a href="InvtoManage.aspx" target="_self">发票类型管理</a> [</span><span><a href="AddInvoType.aspx">添加发票类型</a>]</div>
<div class="clearbox">
</div>
<table width="100%" cellpadding="2" cellspacing="1" class="border" style="background-color: white;">
    <tr class="tdbg">
        <td width="10%" height="24" align="center" class="title">
            ID
        </td>
