<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_ShowGroupUser, App_Web_jrgr22id" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<script type="text/javascript">
    ...
    //    function preview()
    //    {
    //      location.href="Orderlistinfo.aspx?proid="+<%=Request.QueryString["proid"] %>+"&menu=print";           
    //    }
                        ...
                        <ItemTemplate>
                            <tr class="tdbg">
                                ...
                                <td height="24" align="center" title="单击查看详情">
                                    <a href="../user/Usreinfo.aspx?id=<%#Eval("UserID") %>" title="查看会员">
