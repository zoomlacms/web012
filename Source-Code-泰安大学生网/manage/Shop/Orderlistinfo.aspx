<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_Orderlistinfo, App_Web_jrgr22id" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<span>后台管理</span> &gt;&gt; <span>商城管理</span> &gt;&gt; <a href="CartManage.aspx">订单管理</a>&gt;&gt; <span>订单详情</span>
</div>
...
<table width="100%" cellpadding="2" cellspacing="1" class="border" style="background-color: white;" id="TABLE1">
    ...
    <asp:CheckBox ID="email_answer" runat="server" class="l_input" />同时发送E-mail给：<asp:TextBox ID="txtEmail" runat='server' class="l_input"></asp:TextBox>
