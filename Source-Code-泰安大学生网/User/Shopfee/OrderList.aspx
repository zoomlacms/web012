<%@ page language="C#" autoeventwireup="true" inherits="Zoomla.Website.User.Shopfee.OrderList, App_Web_myhmunu0" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<form id="form1" runat="server">
    <div class="r_navigation">
		<span>后台管理</span> &gt;&gt; <span>商城管理</span> &gt;&gt; <a href="OrderList.aspx">订单管理</a> &gt;&gt; <span><a href="OrderList.aspx">代购订单</a></span>	</div>
...
<table width="100%" cellpadding="2" cellspacing="1" class="border" style="background-color: white;">
      <tbody id="Tabs" >
        <tr class="tdbg">
          ...
          <asp:Button ID="souchok" runat="server" class="C_input" Text="搜索" OnClick="souchok_Click" /></td>
        </tr>
      </tbody>
    </table>
    <br />
    <table width="100%" cellpadding="2" cellspacing="1" class="border" style="background-color: white;">
      <tbody id="Tbody1">
        <tr class="tdbg">
          ...
          <td width="75" align="center" class="title"><span class="tdbgleft">其他费用</span></td>
        </tr>
        ...
        <ItemTemplate>
          ...
          <td height="24" align="center"><a onclick="opentitle('../../manage/User/Usreinfo.aspx?id=<%#Eval("userId") %>','查看会员')"
          ...
          <td height="24" align="right"><%#formatcs(DataBinder.Eval(Container,"DataItem.Receivablesamount","{0:N2}"))%><%#getMoney_sign(Eval("Money_code").ToString())%></td>
        ...
        <tr>
          <td height="24" colspan="11"><asp:Button ID="Button1" class="C_input" style="width:110px;" Text="删除选中的订单" runat="server" OnClick="Button1_Click1" OnClientClick="return confirm('不可恢复性删除数据,你确定将该数据删除吗？');" /></td>
        </tr>
      </tbody>
    </table>
</form>
