<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.User.UserBase, App_Web_3lloejsh" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="us_seta" style="margin-top: 10px; width: 100%; float: left" id="manageinfos"
        runat="server">
