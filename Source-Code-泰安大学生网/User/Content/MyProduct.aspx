<%@ page language="C#" autoeventwireup="true" inherits="User_Content_MyProduct, App_Web_3e54r2y4" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div class="us_pynews">
    ...
    <div class="us_seta">
       ...
       <div style="width:100%; float:left;line-height:30px; margin-top:5px;">
            ...
            <asp:Button ID="Button2" runat="server" Text="批量删除" OnClick="btnDeleteAll_Click" OnClientClick="if(!IsSelectedId()){alert('请选择删除项');return false;}else{return confirm('你确定要将所有选择项删除吗？')}" CssClass="i_bottom" UseSubmitBehavior="true" />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
