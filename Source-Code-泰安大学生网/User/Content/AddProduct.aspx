<%@ page language="C#" autoeventwireup="true" inherits="Zoomla.Website.User.Shop.AddProduct, App_Web_3e54r2y4" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<tr align="center">
    ...
    <td id="TabTitle2" class="tabtitle" onclick="ShowTabs(2)">其他信息</td>
    <td id="TabTitle3" class="tabtitle" onclick="ShowTabs(3)">价格设置</td>
    <td id="TabTitle4" class="tabtitle" onclick="ShowTabs(4)">商品属性</td> 
    <td id="TabTitle5" class="tabtitle" onclick="ShowTabs(5)">其他设置</td>
    <td>&nbsp; </td>
</tr>
</table>
<table width="100%" border="0" cellpadding="5" cellspacing="1" class="border">
    <tr class="tdbg">
        ...
        <table width="100%" cellpadding="2" cellspacing="1" style="background-color: white;">
                <tbody id="Tabs0">
                    <tr class="tdbg">
                        <td width="20%" class="tdbgleft"><strong>所属节点：</strong></td>
                        <td>
                    ...
                    <tr class="tdbg">
                        <td class="tdbgleft" style="height: 26px"><strong>商品编号：</strong></td>
                        <td style="width: 592px; height: 26px;"><asp:TextBox ID="ProCode" runat="server" disabled="disabled" class="l_input" Width="155px" />
                        <asp:CheckBox ID="CheckBox1" Text="自动编号" onclick="SetDisabled(this.checked)" runat="server" Checked="True" /></td>
                    </tr>
                    <tr class="tdbg">
                        <td class="tdbgleft"><strong>条形码：</strong></td>
                        <td><asp:TextBox ID="BarCode" runat="server" Width="155px" class="l_input" /></td>
                    </tr>
                    <tr class="tdbg">
                        <td class="tdbgleft"><strong>商品名称：</strong></td>
                        <td><asp:TextBox ID="Proname" runat="server" Width="442px" class="l_input" />
                    ...
                    <tr class="tdbg">
                        <td class="tdbgleft"><strong>用户分类：</strong></td>
                        <td><asp:DropDownList ID="DropDownList1" runat="server"></asp:DropDownList></td>
                    </tr>
                    <tr class="tdbg">
                        <td class="tdbgleft"><strong>关键字：</strong></td>
                        <td><asp:TextBox ID="Kayword" runat="server" Width="155px" class="l_input" /></td>
                    </tr>
                    <tr class="tdbg">
                        <td class="tdbgleft"><strong>商品单位：</strong></td>
                        <td><asp:TextBox ID="ProUnit" runat="server" Width="155px" class="l_input" />
                    ...
                    <tr class="tdbg">
                        <td class="tdbgleft"><strong>商品重量：</strong></td>
                        <td><asp:TextBox ID="Weight" runat="server" Width="91px" class="l_input" />
                    ...
                    <tr class="tdbg">
                        <td class="tdbgleft" style="height: 26px"><strong>服务期限：</strong></td>
                        <td style="height: 26px"><asp:TextBox ID="ServerPeriod" runat="server" Width="53px" class="l_input" />
                    ...
                    <tr class="tdbg">
                        ...
                        <td><asp:RadioButtonList ID="ProClass" runat="server" RepeatDirection="Horizontal" 
                                Width="272px" onselectedindexchanged="ProClass_SelectedIndexChanged" 
                                AutoPostBack="True">
                               ...
                               <div id="TG">
                                 <%--   <asp:MultiView ID="MultiView1" runat="server">
                                      ...
                                      <table>
                                                ...
                                                <tr>
                                                    <td>开始时间</td>
                                                    <td><asp:TextBox ID="ColonelStartTimetxt" runat="server" OnFocus="setday(this)" class="l_input"></asp:TextBox></td>
                                                    <td>结束时间:</td>
                                                    <td>
                                                        <asp:TextBox ID="ColonelendTimetxt" runat="server" OnFocus="setday(this)" class="l_input"></asp:TextBox>
                ...
                <tbody id="Tabs1" style="display: none">        
                    <tr class="tdbg">
                        ...
                        <td>用于首页及栏目页显示，最多255个字符<br />
                            <asp:TextBox ID="Proinfo" runat="server" Height="50px" TextMode="MultiLine" Width="500px" class="l_input" /></td>
                    </tr>
                    <tr class="tdbg">
                        <td class="tdbgleft" width="20%" style="height: 24px"><strong>详细介绍：</strong></td>
                    ...
                    <tr class="tdbg">
                        <td class="tdbgleft" width="20%"><strong>商品清晰图：</strong></td>
                        <td><asp:TextBox ID="Clearimg" runat="server" Width="300px" class="l_input" /><iframe id="bigimgs" style="top:2px" src="../fileupload.aspx?menu=Clearimg" width="100%" height="25px" frameborder="0" marginheight="0" marginwidth="0" scrolling="no"></iframe>
                        </td>
                    </tr>
                    <tr class="tdbg" id="addsmallimg">
                        <td class="tdbgleft" width="20%"><strong>商品缩略图：</strong></td>
                        <td><asp:TextBox ID="Thumbnails" runat="server" Width="300px" class="l_input" /><iframe id="smallimgs" style="top:2px" src="../fileupload.aspx?menu=Thumbnails" width="100%" height="25px" frameborder="0" marginheight="0" marginwidth="0" scrolling="no"></iframe>
                         </td>
                    </tr>     
                </tbody>
                ...
                <tbody id="Tabs2" style="display: none">
                    <tr class="tdbg">
                        <td class="tdbgleft" width="20%"><strong>生 产 商：</strong></td>
                        <td><asp:TextBox ID="Producer" runat="server" Width="214px" class="l_input"></asp:TextBox>【<a href="###" onclick="SelectProducer();">请选择</a>】</td>
                    </tr>
                    <tr class="tdbg">
                        <td class="tdbgleft"><strong>品牌/商标：</strong></td>
                        <td><asp:TextBox ID="Brand" runat="server" Width="214px" class="l_input"></asp:TextBox>【<a href="###" onclick="SelectBrand();">请选择</a>】</td>
                    </tr>
                    <tr class="tdbg">
                        <td class="tdbgleft"><strong>缺货时允许购买:</strong></td>
                        <td><asp:CheckBox ID="Allowed" runat="server" Text="打勾表示缺货时允许购买， 否则缺货时不允许购买" /></td>
                    </tr>
                    <tr class="tdbg">
                        <td class="tdbgleft"><strong>限购数量:</strong></td>
                        <td><asp:TextBox ID="Quota" runat="server" Width="100px" class="l_input" >-1</asp:TextBox> -1为不限制数量 0为不允许购买
                    ...
                    <tr class="tdbg">
                        <td class="tdbgleft"><strong>最低购买数量:</strong></td>
                        <td><asp:TextBox ID="DownQuota" runat="server" Width="100px" class="l_input" >-1</asp:TextBox>-1为不限制数量 0为不允许购买
                    ...
                    <tr class="tdbg">
                        <td class="tdbgleft" style="height: 24px"><strong>库存数量:</strong></td>
                        <td style="height: 24px"><asp:TextBox ID="Stock" runat="server" Width="100px" class="l_input" >10</asp:TextBox>
                    ...
                    <tr class="tdbg">
                        <td class="tdbgleft" style="height: 24px"><strong>库存报警下限:</strong></td>
                        <td style="height: 24px; width: 592px;"><asp:TextBox ID="StockDown" runat="server" Width="100px" class="l_input" >1</asp:TextBox>
                    ...
                    <tr class="tdbg">
                        <td class="tdbgleft"><strong>税率设置:</strong></td>
                        <td>
                    ...
                    <tr class="tdbg">
                        ...
                        <td><asp:TextBox ID="Rate" runat="server" Text="0" class="l_input" />%
                    ...
                    <tr class="tdbg">
                        <td class="tdbgleft"><strong>商品推荐等级:</strong></td>
                        <td>
                ...
                <tbody id="Tabs3" style="display: none">
                    <tr class="tdbg">
                        <td class="tdbgleft" width="20%"><strong>市场参考价：</strong></td>
                        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                            <td style="width: 23%; height: 21px;"><asp:TextBox ID="ShiPrice" runat="server" Width="93px" class="l_input" />元 <font color=red>*</font></td>
                    ...
                    <tr class="tdbg">
                        <td class="tdbgleft"><strong>当前零售价：</strong></td>
                        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                            <td style="width: 23%; height: 20px;"><asp:TextBox ID="LinPrice" runat="server" Width="93px" class="l_input" />元 <font color=red>*</font></td>
                    ...
                    <tr class="tdbg">
                        <td class="tdbgleft"><strong>打折优惠率:</strong></td>
                        <td><asp:TextBox ID="txtRecommend" runat="server" Text="0" Width="93px" class="l_input" /> %
                    ...
                    <tr>
                        ...
                        <td><asp:TextBox ID="txtPoint" runat="server" class="l_input" Enabled="false"></asp:TextBox>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server"
                                ControlToValidate="txtPoint" ErrorMessage="积分价格必须是数字!" ValidationExpression="^(-?\d+)(\.\d+)?$" SetFocusOnError="True"></asp:RegularExpressionValidator></td>
                    </tr>
                    <tr class="tdbg">
                        ...
                        <td>
                            ...
                            <asp:RadioButtonList ID="Wholesales" runat="server" RepeatDirection="Horizontal"
                                ...
                                <asp:TextBox ID="j1" runat="server" class="l_input" Width="68px"  >0</asp:TextBox>元</td>
                                </tr>
                                <tr>
                                <td height="24">② 一次性购买此商品数量满<asp:TextBox ID="s2" runat="server"  class="l_input" Text='50' Width="49px" />时，批发价为
                                            <asp:TextBox ID="j2" runat="server" class="l_input" Width="68px" >0</asp:TextBox>元</td>
                                </tr>
                                <tr>
                                <td height="24">③ 一次性购买此商品数量满<asp:TextBox ID="s3" class="l_input" runat="server" Text='100' Width="49px" />时，批发价为
                                                <asp:TextBox ID="j3" class="l_input" runat="server" Width="68px" >0</asp:TextBox>元</td>
                                </tr>
                                </table>
                                </td>
                                </tr>
                    ...
                    <tr class="tdbg">
                        <td class="tdbgleft"><strong>允许单独销售：</strong></td>
                        <td>
                ...
                <tbody id="Tabs4" style="display: none">
                    ...
                    <tbody id="Tabs5" style="display: none"><tr class="tdbg">
                        <td class="style1" width="20%"><strong>更新时间：</strong></td>
                        <td class="style2"><asp:TextBox ID="UpdateTime" class="l_input" runat="server" /> 
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" id="TABLE1">
    <tr>
        <td align="center" style="height: 59px">&nbsp; &nbsp;
            <asp:Button ID="EBtnSubmit" Text="保存商品信息" runat="server" OnClick="EBtnSubmit_Click1" class="C_input" />
            <input type="button" name="Button2" class="C_input" value="返回列表" onclick="location.href='ProductManage.aspx?NodeID=<%=Request.QueryString["NodeID"]%>'" id="Button2" /></td>
    </tr>
</table>
</form>
</body>
