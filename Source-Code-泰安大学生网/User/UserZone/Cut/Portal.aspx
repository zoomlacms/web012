<%@ page language="C#" autoeventwireup="true" inherits="User_UserZone_Cut_Portal, App_Web_k3p0ohfx" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html >
<!DOCTYPE html>
<html >
...
<div id="Cut_top">
  ...
  <div id="Cut_top_r">
    ...
    <a href="ModuleTerrace.aspx" target="_blank">组件平台</a><a href="PortalList.aspx" >网友主页</a><a onclick="this.style.behavior='url(#default#homepage)';this.setHomePage('');" href="{$SiteURL/}">设为首页</a> <a href="javascript:window.external.addFavorite('{$SiteURL/}','{$SiteName/}');">加入收藏</a><a href="/user/Logout.aspx">退出登录</a> </div>
</div>
