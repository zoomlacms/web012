<%@ page language="C#" autoeventwireup="true" inherits="Pcut_pucut, App_Web_k3p0ohfx" responseencoding="UTF-8" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html >
...
<div id="Cut_top">
  ...
  <div id="Cut_top_r">
    ...
    <a href="ModuleTerrace.aspx" target="_blank">组件平台</a><a href="PortalList.aspx" target="_blank">网友主页</a><a onclick="this.style.behavior='url(#default#homepage)';this.setHomePage('');" href="{$SiteURL/}">设为首页</a> <a href="javascript:window.external.addFavorite('{$SiteURL/}','{$SiteName/}');">加入收藏</a><a href="/user/Logout.aspx">退出登录</a> </div>
</div>
<div id="menu">
...
<form id="Form1" runat=server>
  ...
  <div id="nav_add">
    ...
    <div id="content_add">
      <div id="address">网址：
        <asp:TextBox ID="ass" runat="server" Text="http://www.zoomla.cn"></asp:TextBox>
      </div>
      <div id="title_add">标题：
        <asp:TextBox ID="assTitle" runat="server"></asp:TextBox>
      </div>
      <div id="bt_add">
