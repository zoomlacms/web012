<%@ page language="C#" autoeventwireup="true" inherits="User_UserZone_Pcutlist, App_Web_k3p0ohfx" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head>
<title>网页剪刀列表</title>
...
<body>
  ...
  <div class="clearbox">
    ...
    <asp:CheckBox ID="CheckBox2" runat="server" AutoPostBack="True" Font-Size="9pt" OnCheckedChanged="CheckBox2_CheckedChanged"
        Text="全选" />&nbsp;
        <asp:Button ID="btnShow" CausesValidation="false" Style="width: 110px;" runat="server"
        Text="显示" CssClass="C_input" OnClick="btnShow_Click" OnClientClick="if(!IsSelectedId()){alert('请选择一项项以上');return false;}else{return confirm('你确定要将选中内容设为显示吗？')}" />&nbsp;
    <asp:Button ID="btnHanddle" CausesValidation="false" Style="width: 110px;" runat="server"
        Text="隐藏" CssClass="C_input" OnClick="btnHanddle_Click" OnClientClick="if(!IsSelectedId()){alert('请选择一项项以上');return false;}else{return confirm('你确定要将选中内容设为隐藏吗？')}" />&nbsp;
    <asp:Button ID="btnDal" CausesValidation="false" Style="width: 110px;" runat="server"
        Text="删除" CssClass="C_input" OnClick="btnDal_Click" OnClientClick="if(!IsSelectedId()){alert('请选择一项项以上');return false;}else{return confirm('你确定要将选中内容删除吗？')}" />&nbsp;
