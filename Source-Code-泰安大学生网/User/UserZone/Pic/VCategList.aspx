<%@ page language="C#" autoeventwireup="true" inherits="User_UserZone_Pic_VCategList, App_Web_thoqinuf" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<link rel="stylesheet" type="text/css" href="../../skin/user_main2.css" />
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td style="width: 561px">
                                    可以有自己的相册来存放照片了，你可以从<a href="AddPicCateg.aspx">创建一个相册</a>开始</td>
                                <td>
                                    <a href="AddPicCateg.aspx">
                                        <asp:Image ID="Image2" runat="server" ImageUrl="../Images/FoundCateg.jpg" /></a></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                        ...
                        <asp:DataList ID="dltCategList" runat="server" RepeatColumns="4" >
                            <ItemTemplate>
                                <table>
                                    <tr>
                                        <td align="center">
                                        <a href="PicTureList.aspx?CategID=<%#DataBinder.Eval(Container.DataItem,"ID")%>">
