<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.User.UserZone.Pic.UpPic, App_Web_thoqinuf" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                    ...
                    <h1>
                        您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_blank"><asp:Label
                            ID="LblSiteName" runat="server" Text="Label"></asp:Label></a></span><span> &gt;&gt;
                                ...
                                &gt;&gt; </span><span><a title="我的相册" href='<%=ResolveUrl("~/User/UserZone/Pic/CategList.aspx")%>'>我的相册</a></span></span>&gt;&gt;上传相片
                    </h1>
                </div></div>
                    ...
                    <td>
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr style="height: 40px">
                                ...
                                <td>
                                    <input id="UpPic3" type="file" runat="server" /></td>
                            </tr>
                            <tr style="height: 40px">
                                <td>
