<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.User.UserZone.Pic.ShowPic, App_Web_thoqinuf" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                    ...
                    <h1>
                        您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_blank"><asp:Label
                            ID="LblSiteName" runat="server" Text="Label"></asp:Label></a></span><span> &gt;&gt;
                                ...
                                &gt;&gt; </span><span><a title="我的相册" href='<%=ResolveUrl("~/User/UserZone/Pic/CategList.aspx")%>'>我的相册</a></span></span>&gt;&gt;<%=CategName %>
                    </h1>
                </div>
            </div>
                            ...
                            <td align="center">
                                <table width="400px">
                                    <tr>
                                        ...
                                        <td style="height: 35px">
                                            <asp:LinkButton ID="LinkButton3" runat="server" OnClick="LinkButton3_Click" OnClientClick="return confirm('你确定要删除这张相片吗？')" CausesValidation="false">删除这张照片</asp:LinkButton></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" style="height: 35px">
                                            <asp:LinkButton ID="LinkButton2" runat="server" OnClick="LinkButton2_Click" CausesValidation="false">把这张照片设为相册封面</asp:LinkButton></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                                    ...
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <table width="760" border="1">
                                                <tr>
                                                    <td style="width: 140px" rowspan="2" align="center">
                                                        <table>
                                                            <tr>
                                                                <td style="height: 80px">
                                                                    <a>
                                                                        <asp:Image ID="Image1" runat="server" ImageUrl='<%#DataBinder.Eval(Container.DataItem,"UserPic") %>' /></a></td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <a>
                                                        ...
                                                        <table width="100%">
                                                            <tr>
                                                                <td align="left" style="color: gray">
                                                                    <%#DataBinder.Eval(Container.DataItem, "CritiqueTime")%>
                                                                </td>
                                                                <td align="right">
                                                ...
                                                <tr>
                                                    <td style="height: 100px" valign="top">
                                                        <%#DataBinder.Eval(Container.DataItem, "CritiqueContent")%>
                                                    </td>
                                                </tr>
                                            </table>
                                        </ItemTemplate>
