<%@ page language="C#" autoeventwireup="true" inherits="CategList, App_Web_thoqinuf" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td style="width: 561px">
                                可以有自己的相册来存放照片了，你可以从<a href="AddPicCateg.aspx">创建一个相册</a>开始
                            </td>
                            <td>
