<%@ page language="C#" autoeventwireup="true" inherits="MovieAdd, App_Web_qi20l2w5" enableEventValidation="false" viewStateEncryptionMode="Never" %>
		...
		<div class="us_pynews" style="width: 98%">
				您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_blank"><asp:Label
					ID="LblSiteName" runat="server" Text="Label"></asp:Label></a></span><span> &gt;&gt;
						...
						会员中心</a></span><span> &gt;&gt; </span><span>电影</span>
		</div>
		...
		<table border="1" cellpadding="0" cellspacing="0" height="167" width="100%" align="center">
			<tr>
				<td>
					<h3>
						&nbsp; &nbsp;
						<img src="../Images/ico_movie_b.gif" style="width: 57px; height: 54px" />添加电影</h3>
				</td>
			</tr>
			<tr>
					...
					<table width="100%" height="246" border="0" cellpadding="0" cellspacing="0">
						<tr>
							<td width="29%" align="center">
								&nbsp;<font style="font-size: 12px">电影名称：</font>
							</td>
							<td width="71%">
						...
						<tr>
							<td align="center">
								&nbsp;<font style="font-size: 12px">又名：</font>
							</td>
							<td>
								&nbsp;<asp:TextBox ID="othertitletxt" runat="server"></asp:TextBox>
							</td>
						</tr>
						<tr>
							<td align="center">
								&nbsp;<font style="font-size: 12px">导演：</font>
							</td>
							<td>
						...
						<tr>
							<td align="center">
								&nbsp;<font style="font-size: 12px">语言：</font>
							</td>
							<td>
						...
						<tr>
							<td align="center">
								&nbsp;<font style="font-size: 12px">制片国家/地区：</font>
							</td>
							<td>
								&nbsp;<asp:TextBox ID="concermtxt" runat="server"></asp:TextBox>
								<asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="yeartxt"
									ErrorMessage="不能为空"></asp:RequiredFieldValidator>
							</td>
						</tr>
						<tr>
							<td align="center">
								&nbsp;<font style="font-size: 12px">上映年度：</font>
							</td>
							<td>
								...
								<asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="不能为空"
									ControlToValidate="yeartxt"></asp:RequiredFieldValidator>
								<asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="yeartxt"
									ErrorMessage="请输入正确的上映年份 如：2008" Operator="DataTypeCheck" Type="Integer"></asp:CompareValidator>
							</td>
						</tr>
						<tr>
							<td align="center">
								&nbsp;<font style="font-size: 12px">图片：</font>
							</td>
							<td>
								...
								<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="FileUpload1"
									ErrorMessage="不能为空"></asp:RequiredFieldValidator>
								<asp:Label ID="Label1" runat="server" ForeColor="Red" Text="图片大小不得超过1024KB"></asp:Label>
							</td>
						</tr>
						<tr>
							<td align="center">
						...
						<tr>
							...
							<td>
								&nbsp;<asp:Button ID="sBtn" runat="server" OnClick="sBtn_Click" Text="添加保存" />
							</td>
						</tr>
					</table>
				</td>
