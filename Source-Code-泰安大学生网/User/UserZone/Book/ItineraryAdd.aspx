<%@ page language="C#" autoeventwireup="true" inherits="ItineraryAdd, App_Web_qi20l2w5" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <table border="1" cellpadding="0" cellspacing="0" height="167" width="100%" align="center">
                <tr>
                    <td>
                        <h3>
                            &nbsp; &nbsp;
                            <img src="../Images/c94b5c389e8cbfebb311c764.jpg" style="width: 57px; height: 54px" />添加旅途</h3>
                    </td>
                </tr>
                <tr>
                    <td style="height: 92px">
                        <table width="100%" height="246" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td align="center">
                                    &nbsp;<span class="pl"><span class="pl">出行时间</span>：</span></td>
                                <td>
