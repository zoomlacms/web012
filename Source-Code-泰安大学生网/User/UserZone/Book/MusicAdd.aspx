<%@ page language="C#" autoeventwireup="true" inherits="MusicAdd, App_Web_qi20l2w5" title="音乐" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <table border="1" cellpadding="0" cellspacing="0" height="167" width="100%" align="center">
                <tr>
                    <td>
                        <h3>
                            &nbsp; &nbsp;
                            <img src="../Images/c94b5c389e8cbfebb311c764.jpg" style="width: 57px; height: 54px" />添加音乐</h3>
                    </td>
                </tr>
                <tr>
                    <td style="height: 92px">
                        <table width="100%" height="246" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td align="center">
                                    &nbsp;<font style="font-size: 12px">演唱者</font>：
                                </td>
                                <td>
                            ...
                            <tr>
                                <td align="center">
                                    &nbsp;<font style="font-size: 12px">词</font>：
                                </td>
                                <td>
                            ...
                            <tr>
                                <td align="center">
                                    &nbsp;<font style="font-size: 12px">曲</font>：
                                </td>
                                <td>
                            ...
                            <tr>
                                <td align="center">
                                    &nbsp;<font style="font-size: 12px">出版者</font>：
                                </td>
                                <td>
                            ...
                            <tr>
                                <td align="center">
                                    &nbsp;<font style="font-size: 12px">发行时间</font>：
                                </td>
                                <td>
                                    ...
                                    <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="yeartxt"
                                        ErrorMessage="请输入正确的发行年份 如：2008" Operator="DataTypeCheck" Type="Integer"></asp:CompareValidator>
                                </td>
                            </tr>
                            <tr>
                                <td align="center">
                                ...
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="FileUpload1"
                                        ErrorMessage="不能为空"></asp:RequiredFieldValidator>
                                    <asp:Label ID="Label1" runat="server" ForeColor="Red" Text="图片大小不得超过 1024KB"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td align="center">
