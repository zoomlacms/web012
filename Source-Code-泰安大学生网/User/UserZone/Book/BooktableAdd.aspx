<%@ page language="C#" autoeventwireup="true" inherits="BooktableAdd, App_Web_qi20l2w5" title="书籍" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                ...
                <h1>
                    您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_blank"><asp:Label
                        ID="LblSiteName" runat="server" Text="Label"></asp:Label></a></span><span> &gt;&gt;
                            ...
                            会员中心</a></span><span> &gt;&gt; </span><span>书籍</span>
                 </h1>
            </div>
            <div class="cleardiv">
            </div>
            ...
            <table border="1" cellpadding="0" cellspacing="0" height="167" width="100%" align="center">
                <tr>
                    <td>
                        <h3>
                            &nbsp; &nbsp;
                            <img src="../Images/icon_80.gif" style="width: 57px; height: 54px" />添加书籍</h3>
                    </td>
                </tr>
                <tr>
                            ...
                            <tr>
                                ...
                                <td style="height: 24px">
                                    ...
                                    <asp:CompareValidator ID="CompareValidator2" runat="server" ControlToValidate="pricetxt"
                                        ErrorMessage="请输入正确的书本价格" Operator="DataTypeCheck" Type="Double"></asp:CompareValidator>
                                </td>
                            </tr>
                            <tr>
                                <td align="center">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="yeartxt"
                                        ErrorMessage="请输入正确的年份 如2008" Operator="DataTypeCheck" Type="Integer"></asp:CompareValidator>
                                </td>
                            </tr>
                            <tr>
                                <td align="center">
