<%@ page language="C#" autoeventwireup="true" inherits="ItineraryList, App_Web_f4n0rzcf" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" width="100%">
                        <tr>
                            <td style="padding-left: 20px" class="catebar" height="26">
                                <span class="M"><font class="textlink">景点</font></span>
                            </td>
                        </tr>
                    </table>
                </td>
                                                    ...
                                                    <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                                        <tr>
                                                            <td height="25" valign="bottom">
                                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong><font color="#004d00">[<a href="ItineraryShow.aspx?bID=<%#DataBinder.Eval(Container.DataItem,"ID") %>"><%# DataBinder.Eval(Container.DataItem,"BookTitle")%></a>]</font></strong>
                                                            </td>
                                                            <td align="right">
                                                        ...
                                                        <tr>
                                                            <td width="23%" class="lh13" id="bookdetail1" style="padding-bottom: 3px; padding-left: 0px;
                                                                ...
                                                                &nbsp; &nbsp; <a href="ItineraryShow.aspx?bID=<%#DataBinder.Eval(Container.DataItem,"ID") %>">
