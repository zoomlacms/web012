<%@ page language="C#" autoeventwireup="true" inherits="User_Message_MessageLeft, App_Web_t5tqbwkd" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
                ...
                <td height="22" valign="top" class="left_font">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td valign="top">
                                <div class="left_font" style="cursor: hand" onclick="show('td2')">
                                    信息管理</div>
                            </td>
                        </tr>
                    </table>
...
<%--                        <tr>
                            <td bgcolor="#FFFFFF">
                                <img src="../../App_Themes/UserThem/images/icon_02.gif" width="5" height="5" align="middle">&nbsp;&nbsp;
                                <a href="#" target="main_right">消息提醒设置</a>
                            </td>
                        </tr>--%>
                    </table>
                </td>
