<%@ page language="C#" autoeventwireup="true" inherits="User_Message_MessageOutbox, App_Web_t5tqbwkd" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>发件箱</title>
...
<div class="us_topinfo">
  <div class="us_pynews">
	  ...
	  您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_blank"><asp:Label ID="LblSiteName" runat="server" Text="Label"></asp:Label></a></span><span> &gt;&gt; </span><span><a title="会员中心" href="/User/Default.aspx" target="_parent">会员中心</a></span><span> &gt;&gt; </span><span><a title="短消息管理" href="/User/MessageOutbox.aspx">发件箱</a></span></span>
  </div>
