<%@ page language="C#" autoeventwireup="true" inherits="User_UserShop_UserOrderinfo, App_Web_fipepwvn" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>订单详情</title>
...
<table width="100%" cellspacing="1" class="us_seta" style="background-color: white;font-size:12px">
    ...
    <tr class="tdbg"onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        <td colspan="5"></td>
        <td height="24" align="left" colspan="5">合计：&nbsp;
            <asp:Label ID="Label2" runat="server" CssClass="l_input" Width="116px" Height="17px"></asp:Label><span id="tips" runat="server"></span>&nbsp;
        </td>
    </tr>
    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
...
<!--endprint-->
<table width="100%" cellpadding="2" cellspacing="1" class="us_seta" style="background-color: white;" id="TABLE1">
    <asp:Repeater ID="procart2" runat="server">
        <ItemTemplate>
        </ItemTemplate>
    </asp:Repeater>
     <tr class="tdbg">
        <td width="25%"><asp:HiddenField ID="orderID" runat="server" />
        <asp:Button ID="Button4" class="C_input"  style="width:100px;" runat="server" Text="订单有效" Width="100px" OnClientClick="SelectOrderState();return false;" /></td>
       <td><input type="button" ID="Button2" class="C_input" style="width:100px;" runat="server" value="已经支付" Width="100px" /></td>
        <td><asp:Button ID="Button9" class="C_input"  style="width:100px;" runat="server" Text="结清订单" Width="100px" Enabled="false" /></td>
        <td><asp:Button ID="btn3" class="C_input"  style="width:100px;" runat="server" Text="订单完成" Width="100px" OnClick="Button14_Click"  /></td>
       </tr>
    <tr  class="tdbg">
        <td><asp:Button ID="Button7" class="C_input"  style="width:100px;" runat="server" Text="客户已签收" Width="100px"  Enabled="false" /></td>
        <td><asp:Button ID="Button11" class="C_input"  style="width:100px;" runat="server" Text="开发票" Width="100px" /></td>
    ...
    <tr class="tdbg">
      <td width="25%"><asp:Button ID="Button3" class="C_input"  style="width:100px;" runat="server" Width="100px" Text="发货" OnClientClick="SelectDelivery();return false;"  /></td>
      <td width="25%"><asp:Button ID="Button13" class="C_input"  style="width:100px;" runat="server" Text="暂停处理" Width="100px" /></td>
      <td><asp:Button ID="Button15" class="C_input"  style="width:100px;" runat="server" Text="打印订单" Width="100px" OnClientClick="preview();return false;"  /></td>
      <td><asp:Button ID="Button1" class="C_input"  style="width:100px;" runat="server" Text="打印签收单" Width="100px" OnClientClick="order();return false;"  /><br /></td>
    </tr>
</table>
<asp:Button ID="Button5" class="C_input"  style="width:100px;" runat="server" Text="取消确认" Width="100px" OnClick="Button5_Click" Visible="false"  />
</div>
<div id="msgDiv"><div id="msgShut" onclick="close()">关闭</div>
<div id="msgDetail"></div></div><div id="bgDiv"></div>
