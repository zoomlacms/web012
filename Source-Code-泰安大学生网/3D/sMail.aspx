<%@ page language="C#" autoeventwireup="true" inherits="_3D_sMail, App_Web_ow0o10ge" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
                <tr>
                    <td align="center" colspan="2" class="spacingtitle">
                        <b>Send E - Mail to Supplier</b></td>
                </tr>
                <tr class="tdbg">
                    <td width="15%" align="right" class="tdbgleft">
                        <strong>Supplier's E-Mail：</strong></td>
                    <td>
                        <table>
                            <tr>
                            <td>
                            ...
                            <tr>
                                <td colspan="5">
                                    <asp:TextBox ID="txtSend" Width="476px" Rows="10" runat="server"
                ...
                <tr class="tdbg">
                    <td align="right" class="tdbgleft">
                        <strong>E-mail content：</strong></td>
                    <td>
