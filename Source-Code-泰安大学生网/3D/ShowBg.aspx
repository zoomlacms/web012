<%@ page language="C#" autoeventwireup="true" inherits="_3D_ShowBg, App_Web_ow0o10ge" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
选择展位
  ...
  <div style="height:350px; ">
      ...
      <div id="tdmsg" style="float:left; width: 60%; height: 330px; text-align:center;border:1px solid black;">
  ...
  <div style="text-align:center"> <asp:Button ID="Button1" runat="server" 
          Text="提交" onclick="Button1_Click" /></div>
</div>
