<%@ page language="C#" autoeventwireup="true" inherits="_3D_DUserAddPro, App_Web_ow0o10ge" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr align="center">
            ...
            <td id="TabTitle4" class="tabtitle" onclick="ShowTabs(4)" style="display:none">
                <div id="result_box" dir="ltr">
                    促销</div>
            </td>
            <td id="TabTitle5" class="tabtitle" onclick="ShowTabs(5)" style="display:none">
                属性
            </td>
            <td id="TabTitle6" class="tabtitle" onclick="ShowTabs(6)" style="display:none">
                设置
                <td>
                    &nbsp;
                </td>
                ...
                <table width="100%" cellpadding="2" cellspacing="1" style="background-color: white;">
                    <tbody id="Tabs0">
                        ...
                        <tr class="tdbg" style="display:none">
                            ...
                            <td>
                                <asp:TextBox ID="ProUnit" runat="server" Width="155px" Text="" />
                                <span class="STYLE1">
                                </span>
                            </td>
                        </tr>
                    ...
                    <tbody id="Tabs1" style="display: none">
                        ...
                        <tr class="tdbg">
                            ...
                            <td>
                                <asp:TextBox ID="Clearimg" runat="server" Width="300px" /><span class="STYLE1">&nbsp;*</span><asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="Can not be empty" ControlToValidate="Clearimg"></asp:RequiredFieldValidator><span class="STYLE1">
                                <br />
                        ...
                        <tr class="tdbg" id="addsmallimg">
                            ...
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Can not be empty" ControlToValidate="Thumbnails"></asp:RequiredFieldValidator>
                                <br />
                    ...
                    <tbody id="Tabs2" style="display: none">
                        ...
                        <tr class="tdbg">
                            <td class="tdbgleft">
                                <strong>Allowing the purchase of out-of-stock:</strong>
                            </td>
                            <td>
                                <asp:CheckBox ID="Allowed" runat="server" Text="检查，允许购买脱销，或脱销时购买是不允许的" />
                            </td>
                        </tr>
                        <tr class="tdbg">
                            <td class="tdbgleft">
                    ...
                    <tbody id="Tabs3" style="display: none">
                            ...
                            <td>
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td class="style1">
                                            USD
                                            <asp:TextBox ID="ShiPrice" runat="server" Width="93px" />
                                            &nbsp;<font color="red">*</font>
                                        </td>
                                        <td width="10px" style="height: 21px">
                                            .</td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr class="tdbg" style="display: none">
                            <td class="tdbgleft">
                                <strong>目前的零售价：</strong>
                            </td>
                            <td>
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td style="width: 23%; height: 20px;">
                                            <asp:TextBox ID="LinPrice" runat="server" Width="93px" Text="1" />
                                            元 
                                        </td>
                    ...
                    <tbody id="Tabs4" style="display: none">
                        <tr class="tdbg">
                            ...
                            <td>
                                购买&nbsp;<asp:TextBox ID="IntegralNum" runat="server" Text="1" Width="26px"></asp:TextBox>&nbsp;件此商品可以得到
                                <asp:TextBox ID="Integral" runat="server" Width="53px" />
                                积分
                    ...
                    <tbody id="Tabs5" style="display: none">
                        <asp:Literal ID="ModelHtml" runat="server"></asp:Literal></tbody><tbody id="Tabs6" style="display: none"><tr class="tdbg">
                            <td class="tdbgleft" width="20%" style="height: 24px">
                                <strong>购买商品积分：</strong>
                            </td>
                            <td style="height: 24px; width: 592px;">
